 ...
 * @package   Nette\Extras
 */
class CheckboxList extends NFormControl
{
	 ...
	 * @return CheckboxList
	 */
	public static function addCheckboxList(NFormContainer $form, $name, $label, array $items = NULL)
	{
	...
	public function __construct($label, array $items = NULL)
	{
		...
		$this->container = /*Nette\Web\*/NHtml::el();
		$this->separator = /*Nette\Web\*/NHtml::el('br');
	...
	public function getControl($key = NULL)
	{
		...
		$label = /*Nette\Web\*/NHtml::el('label');
		...
		foreach ($this->items as $k => $val) {
			...
			if ($val instanceof /*Nette\Web\*/NHtml) {
				$label->setHtml($val);
			} else {

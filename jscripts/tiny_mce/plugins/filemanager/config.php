<?php
    ...
    $mcFileManagerConfig['general.tools'] = "imagemanager,createdir,refresh,zip,upload,edit,rename,cut,copy,paste,delete,selectall,unselectall,view,download,addfavorite,removefavorite"; //createdoc,insert 
    $mcFileManagerConfig['general.disabled_tools'] = "";
    $mcFileManagerConfig['general.error_log'] = "";
    $mcFileManagerConfig['general.language'] = "sk"; // en, sv
    ...
    $mcFileManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/uploaded/files'; // absolute or relative from this script path.
    ...
    $mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,mp4";

...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                '<div class="qq-upload-drop-area"><span>Sem umiestni súbory.</span></div>' +
                '<div class="qq-upload-button">Nahraj súbor</div>' +
        ...
        fileTemplate: '<li>' +
                ...
                '<a class="qq-upload-cancel" href="#">Zrusiť</a>' +
                '<span class="qq-upload-failed-text">Chyba</span>' +
            '</li>',
